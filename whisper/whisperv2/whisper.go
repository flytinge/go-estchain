...
import (
	...
	"github.com/estchain/go-estchain/event/filter"
...
// Whisper represents a dark communication interface through the Estchain
...
// New creates a Whisper client ready to communicate through the Estchain P2P
// network.
func New() *Whisper {
	whisper := &Whisper{
		filters:     filter.New(),
