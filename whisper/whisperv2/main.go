...
import (
	...
	"github.com/estchain/go-estchain/logger"
	"github.com/estchain/go-estchain/p2p"
	"github.com/estchain/go-estchain/p2p/nat"
	"github.com/estchain/go-estchain/whisper"
)
...
func main() {
	...
	// Create an Estchain peer to communicate through
	server := p2p.Server{
		PrivateKey: key,
		MaxPeers:   10,
		Name:       name,
	...
	fmt.Println("Starting Estchain peer...")
	if err := server.Start(); err != nil {
		fmt.Printf("Failed to start Estchain peer: %v.\n", err)
		os.Exit(1)
	}
