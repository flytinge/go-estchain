...
type operation struct {
	...
	halts   bool // indicates whester the operation should halt further execution
	jumps   bool // indicates whester the program counter should not increment
	writes  bool // determines whester this a state modifying operation
	valid   bool // indication whester the retrieved operation is valid and known
	reverts bool // determines whester the operation reverts state (implicitly halts)
	returns bool // determines whester the operations sets the return data content
}
