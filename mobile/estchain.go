...
// Contains all the wrappers from the go-estchain root package.
...
// the Estchain network.
type SyncProgress struct {
	progress estchain.SyncProgress
}
