...
const (
	...
	MessageType_MessageType_EstchainGetAddress       MessageType = 56
	MessageType_MessageType_EstchainAddress          MessageType = 57
	MessageType_MessageType_EstchainSignTx           MessageType = 58
	MessageType_MessageType_EstchainTxRequest        MessageType = 59
	MessageType_MessageType_EstchainTxAck            MessageType = 60
	...
	MessageType_MessageType_EstchainSignMessage      MessageType = 64
	MessageType_MessageType_EstchainVerifyMessage    MessageType = 65
	MessageType_MessageType_EstchainMessageSignature MessageType = 66
...
var MessageType_name = map[int32]string{
	...
	56:  "MessageType_EstchainGetAddress",
	57:  "MessageType_EstchainAddress",
	58:  "MessageType_EstchainSignTx",
	59:  "MessageType_EstchainTxRequest",
	60:  "MessageType_EstchainTxAck",
	61:  "MessageType_GetECDHSessionKey",
	62:  "MessageType_ECDHSessionKey",
	63:  "MessageType_SetU2FCounter",
	64:  "MessageType_EstchainSignMessage",
	65:  "MessageType_EstchainVerifyMessage",
	66:  "MessageType_EstchainMessageSignature",
...
var MessageType_value = map[string]int32{
	...
	"MessageType_EstchainGetAddress":       56,
	"MessageType_EstchainAddress":          57,
	"MessageType_EstchainSignTx":           58,
	"MessageType_EstchainTxRequest":        59,
	"MessageType_EstchainTxAck":            60,
	"MessageType_GetECDHSessionKey":        61,
	"MessageType_ECDHSessionKey":           62,
	"MessageType_SetU2FCounter":            63,
	"MessageType_EstchainSignMessage":      64,
	"MessageType_EstchainVerifyMessage":    65,
	"MessageType_EstchainMessageSignature": 66,
...
// *
// Request: Ask device for Estchain address corresponding to address_n path
// @next PassphraseRequest
// @next EstchainAddress
// @next Failure
type EstchainGetAddress struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	ShowDisplay      *bool    `protobuf:"varint,2,opt,name=show_display,json=showDisplay" json:"show_display,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}

func (m *EstchainGetAddress) Reset()                    { *m = EstchainGetAddress{} }
func (m *EstchainGetAddress) String() string            { return proto.CompactTextString(m) }
func (*EstchainGetAddress) ProtoMessage()               {}
func (*EstchainGetAddress) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{22} }

func (m *EstchainGetAddress) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *EstchainGetAddress) GetShowDisplay() bool {
	if m != nil && m.ShowDisplay != nil {
		return *m.ShowDisplay
	}
	return false
...
// *
// Response: Contains an Estchain address derived from device private seed
// @prev EstchainGetAddress
type EstchainAddress struct {
	Address          []byte `protobuf:"bytes,1,req,name=address" json:"address,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *EstchainAddress) Reset()                    { *m = EstchainAddress{} }
func (m *EstchainAddress) String() string            { return proto.CompactTextString(m) }
func (*EstchainAddress) ProtoMessage()               {}
func (*EstchainAddress) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{24} }

func (m *EstchainAddress) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
// @next PassphraseRequest
// @next PinMatrixRequest
// @next EstchainTxRequest
// @next Failure
type EstchainSignTx struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	Nonce            []byte   `protobuf:"bytes,2,opt,name=nonce" json:"nonce,omitempty"`
...
func (m *EstchainSignTx) Reset()                    { *m = EstchainSignTx{} }
func (m *EstchainSignTx) String() string            { return proto.CompactTextString(m) }
func (*EstchainSignTx) ProtoMessage()               {}
func (*EstchainSignTx) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{49} }

func (m *EstchainSignTx) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *EstchainSignTx) GetNonce() []byte {
	if m != nil {
		return m.Nonce
	}
	return nil
...
func (m *EstchainSignTx) GetGasPrice() []byte {
	if m != nil {
		return m.GasPrice
	}
	return nil
...
func (m *EstchainSignTx) GetGasLimit() []byte {
	if m != nil {
		return m.GasLimit
	}
	return nil
...
func (m *EstchainSignTx) GetTo() []byte {
	if m != nil {
		return m.To
	}
	return nil
...
func (m *EstchainSignTx) GetValue() []byte {
	if m != nil {
		return m.Value
	}
	return nil
...
func (m *EstchainSignTx) GetDataInitialChunk() []byte {
	if m != nil {
...
func (m *EstchainSignTx) GetDataLength() uint32 {
...
func (m *EstchainSignTx) GetChainId() uint32 {
...
func (m *EstchainTxRequest) Reset()                    { *m = EstchainTxRequest{} }
func (m *EstchainTxRequest) String() string            { return proto.CompactTextString(m) }
func (*EstchainTxRequest) ProtoMessage()               {}
func (*EstchainTxRequest) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{50} }

func (m *EstchainTxRequest) GetDataLength() uint32 {
	if m != nil && m.DataLength != nil {
		return *m.DataLength
	}
	return 0
...
func (m *EstchainTxRequest) GetSignatureV() uint32 {
...
func (m *EstchainTxRequest) GetSignatureR() []byte {
	if m != nil {
		return m.SignatureR
	}
	return nil
...
func (m *EstchainTxRequest) GetSignatureS() []byte {
	if m != nil {
		return m.SignatureS
	}
	return nil
...
// @prev EstchainTxRequest
// @next EstchainTxRequest
type EstchainTxAck struct {
	DataChunk        []byte `protobuf:"bytes,1,opt,name=data_chunk,json=dataChunk" json:"data_chunk,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *EstchainTxAck) Reset()                    { *m = EstchainTxAck{} }
func (m *EstchainTxAck) String() string            { return proto.CompactTextString(m) }
func (*EstchainTxAck) ProtoMessage()               {}
func (*EstchainTxAck) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{51} }

func (m *EstchainTxAck) GetDataChunk() []byte {
	if m != nil {
		return m.DataChunk
	}
	return nil
...
// *
// Request: Ask device to sign message
// @next EstchainMessageSignature
// @next Failure
type EstchainSignMessage struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	Message          []byte   `protobuf:"bytes,2,req,name=message" json:"message,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}

func (m *EstchainSignMessage) Reset()                    { *m = EstchainSignMessage{} }
func (m *EstchainSignMessage) String() string            { return proto.CompactTextString(m) }
func (*EstchainSignMessage) ProtoMessage()               {}
func (*EstchainSignMessage) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{52} }

func (m *EstchainSignMessage) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *EstchainSignMessage) GetMessage() []byte {
	if m != nil {
		return m.Message
	}
	return nil
...
// @next Success
// @next Failure
type EstchainVerifyMessage struct {
...
func (m *EstchainVerifyMessage) Reset()                    { *m = EstchainVerifyMessage{} }
func (m *EstchainVerifyMessage) String() string            { return proto.CompactTextString(m) }
func (*EstchainVerifyMessage) ProtoMessage()               {}
func (*EstchainVerifyMessage) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{53} }

func (m *EstchainVerifyMessage) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *EstchainVerifyMessage) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func (m *EstchainVerifyMessage) GetMessage() []byte {
	if m != nil {
		return m.Message
	}
	return nil
...
// *
// Response: Signed message
// @prev EstchainSignMessage
type EstchainMessageSignature struct {
	Address          []byte `protobuf:"bytes,1,opt,name=address" json:"address,omitempty"`
	Signature        []byte `protobuf:"bytes,2,opt,name=signature" json:"signature,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *EstchainMessageSignature) Reset()                    { *m = EstchainMessageSignature{} }
func (m *EstchainMessageSignature) String() string            { return proto.CompactTextString(m) }
func (*EstchainMessageSignature) ProtoMessage()               {}
func (*EstchainMessageSignature) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{54} }

func (m *EstchainMessageSignature) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *EstchainMessageSignature) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*EstchainGetAddress)(nil), "EstchainGetAddress")
	proto.RegisterType((*Address)(nil), "Address")
	proto.RegisterType((*EstchainAddress)(nil), "EstchainAddress")
	...
	proto.RegisterType((*EstchainSignTx)(nil), "EstchainSignTx")
	proto.RegisterType((*EstchainTxRequest)(nil), "EstchainTxRequest")
	proto.RegisterType((*EstchainTxAck)(nil), "EstchainTxAck")
	proto.RegisterType((*EstchainSignMessage)(nil), "EstchainSignMessage")
	proto.RegisterType((*EstchainVerifyMessage)(nil), "EstchainVerifyMessage")
	proto.RegisterType((*EstchainMessageSignature)(nil), "EstchainMessageSignature")
