...
// Package bind generates Estchain contract Go bindings.
//
// Detailed usage document and tutorial available on the go-estchain Wiki page:
// https://github.com/estchain/go-estchain/wiki/Native-DApps:-Go-bindings-to-Estchain-contracts
package bind
