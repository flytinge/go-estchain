...
// Package chequebook package wraps the 'chequebook' Estchain smart contract.
//
// The functions in this package allow using chequebook for
// issuing, receiving, verifying cheques in ester; (auto)cashing cheques in ester
// as well as (auto)depositing ester to the chequebook contract.
package chequebook
...
import (
	...
	"github.com/estchain/go-estchain/contracts/chequebook/contract"
	"github.com/estchain/go-estchain/core/types"
	"github.com/estchain/go-estchain/crypto"
	"github.com/estchain/go-estchain/log"
	"github.com/estchain/go-estchain/swarm/services/swap/swap"
)
...
// * depositing ester to the chequebook
// * watching incoming ester
...
// Cash cashes the cheque by sending an Estchain transaction.
