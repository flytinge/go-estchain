...
// Package tests implements execution of Estchain JSON tests.
package tests
...
/* See https://github.com/estchain/tests/wiki/Blockchain-Tests-II

   Whester a block is valid or not is a bit subtle, it's defined by presence of
