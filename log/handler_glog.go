...
type GlogHandler struct {
	...
	override  uint32 // Flag whester overrides are used, atomically accessible
	backtrace uint32 // Flag whester backtrace location is set
...
func (h *GlogHandler) Log(r *Record) error {
	// If backtracing is requested, check whester this is the callsite
