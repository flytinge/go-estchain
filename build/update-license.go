...
Please review the resulting diff to check whester the correct
...
var (
	...
	authorsFileHeader = "# This is the official list of go-estchain authors for copyright purposes.\n\n"
)

// this template generates the license comment.
// its input is an info structure.
var licenseT = template.Must(template.New("").Parse(`
// Copyright {{.Year}} The go-estchain Authors
...
func (i info) Whole(startOfSentence bool) string {
	...
	if startOfSentence {
		return "The go-estchain library"
	}
	return "the go-estchain library"
}
