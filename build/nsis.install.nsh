...
!define HELPURL "https://github.com/estchain/go-estchain/issues"
!define UPDATEURL "https://github.com/estchain/go-estchain/releases"
!define ABOUTURL "https://github.com/estchain/go-estchain#estchain-go"
...
Section "Geth" GETH_IDX
  ...
  SimpleFC::AdvRemoveRule "Geth incoming peers (TCP:31666)"
  SimpleFC::AdvRemoveRule "Geth outgoing peers (TCP:31666)"
  SimpleFC::AdvRemoveRule "Geth UDP discovery (UDP:31666)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Geth incoming peers (TCP:31666)" ""  6 1 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "Estchain" 31666 "" "" ""
  SimpleFC::AdvAddRule "Geth outgoing peers (TCP:31666)" ""  6 2 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "Estchain" "" 31666 "" ""
  SimpleFC::AdvAddRule "Geth UDP discovery (UDP:31666)" "" 17 2 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "Estchain" "" 31666 "" ""

  # Set default IPC endpoint (https://github.com/estchain/EIPs/issues/147)
  ${EnvVarUpdate} $0 "ESTCHAIN_SOCKET" "R" "HKLM" "\\.\pipe\geth.ipc"
  ${EnvVarUpdate} $0 "ESTCHAIN_SOCKET" "A" "HKLM" "\\.\pipe\geth.ipc"
