...
import (
	...
	"github.com/estchain/go-estchain/crypto/ecies"
	"github.com/estchain/go-estchain/crypto/secp256k1"
...
// and also verifies whester the encryption handshake 'worked' and the
...
type authMsgV4 struct {
	gotPlain bool // whester read packet had plain format.
