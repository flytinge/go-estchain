...
// Contains reports whester the given IP is contained in the list.
...
// IsLAN reports whester an IP is a local network address.
...
// IsSpecialNetwork reports whester an IP is located in a special-use network range
...
// CheckRelayIP reports whester an IP relayed from the given sender IP
