...
import (
	...
	"github.com/estchain/go-estchain/p2p/simulations/adapters"
)
...
// starting nodes and connecting them togester.
//
...
// Connect connects two nodes togester by calling the "admin_addPeer" RPC
...
type Node struct {
	...
	// Up tracks whester or not the node is running
	Up bool `json:"up"`
}
...
type Conn struct {
	...
	// Up tracks whester or not the connection is active
	Up bool `json:"up"`
...
// nodesUp returns whester both nodes are currently up
