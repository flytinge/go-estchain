...
creating a collection of devp2p nodes, connecting them togester to form a
...
RPC ports (`31666` and `8666` respectively).
...
* `Expect` - an expectation function which returns whester or not a
...
As a concrete example, consider a simulated network of Estchain nodes. An
