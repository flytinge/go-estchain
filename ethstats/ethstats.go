...
// Service implements an Estchain netstats reporting daemon that pushes local
// chain statistics up to a monitoring server.
type Service struct {
	server *p2p.Server        // Peer-to-peer server to retrieve networking infos
	eth    *eth.Estchain      // Full Estchain service if monitoring a full node
	les    *les.LightEstchain // Light Estchain service if monitoring a light node
...
func New(url string, ethServ *eth.Estchain, lesServ *les.LightEstchain) (*Service, error) {
