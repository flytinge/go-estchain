...
type RemoteAgent struct {
	...
	running int32 // running indicates whester the agent is active. Call atomically
}
...
// whester the solution was accepted or not (not can be both a bad pow as well as
