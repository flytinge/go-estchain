...
// TestPendingTxFilter tests whester pending tx filters retrieve all pending transactions that are posted to the event mux.
...
// TestLogFilterCreation test whester a given filter criteria makes sense.
...
// TestInvalidLogFilterCreation tests whester invalid filter log criteria results in an error
...
// TestLogFilter tests whester log filters match the correct logs that are posted to the event feed.
