...
// Syncing provides information when this nodes starts synchronising with the Estchain network and when it's finished.
...
type SyncingResult struct {
	...
	Status  estchain.SyncProgress `json:"status"`
}
