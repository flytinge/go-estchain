...
// stateReq represents a batch of state fetch requests groupped togester into
...
type stateReq struct {
	...
	dropped  bool                       // Flag whester the peer dropped off early
}
...
// peer into the state trie, returning whester anything useful was written or any
// error occurred.
