...
import (
	...
	"github.com/estchain/go-estchain/trie"
)

const defaultTraceTimeout = 5 * time.Second

// PublicEstchainAPI provides an API to access Estchain full node-related
// information.
type PublicEstchainAPI struct {
	e *Estchain
}

// NewPublicEstchainAPI creates a new Estchain protocol API for full nodes.
func NewPublicEstchainAPI(e *Estchain) *PublicEstchainAPI {
...
func (api *PublicEstchainAPI) Hashrate() hexutil.Uint64 {
...
func NewPublicMinerAPI(e *Estchain) *PublicMinerAPI {
...
func NewPrivateMinerAPI(e *Estchain) *PrivateMinerAPI {
...
// PrivateAdminAPI is the collection of Estchain full node-related APIs
...
// admin methods of the Estchain service.
func NewPrivateAdminAPI(eth *Estchain) *PrivateAdminAPI {
...
// PublicDebugAPI is the collection of Estchain full node APIs exposed
...
// related public debug methods of the Estchain service.
func NewPublicDebugAPI(eth *Estchain) *PublicDebugAPI {
...
// PrivateDebugAPI is the collection of Estchain full node APIs exposed over
...
// private debug methods of the Estchain service.
func NewPrivateDebugAPI(config *params.ChainConfig, eth *Estchain) *PrivateDebugAPI {
