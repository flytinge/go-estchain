...
import (
	...
	"github.com/estchain/go-estchain/swarm/network/kademlia"
	"github.com/estchain/go-estchain/swarm/services/swap"
...
Timeout serves to indicate whester the responder is forwarding the query within
the timeout or not.
...
type peersMsgData struct {
	Peers   []*peerAddr //
	Timeout uint64      //
	timeout *time.Time  // indicate whester responder is expected to deliver content
