...
import (
	...
	"github.com/estchain/go-estchain/cmd/utils"
	"github.com/estchain/go-estchain/common"
	"github.com/estchain/go-estchain/console"
	"github.com/estchain/go-estchain/contracts/ens"
	"github.com/estchain/go-estchain/crypto"
	"github.com/estchain/go-estchain/ethclient"
	"github.com/estchain/go-estchain/internal/debug"
	...
	"github.com/estchain/go-estchain/swarm"
	bzzapi "github.com/estchain/go-estchain/swarm/api"
...
var (
	...
	SwarmSwapAPIFlag = cli.StringFlag{
		Name:  "swap-api",
		Usage: "URL of the Estchain API provider to use to settle SWAP payments",
	}
	...
	EnsAPIFlag = cli.StringFlag{
		Name:  "ens-api",
		Usage: "URL of the Estchain API provider to use for ENS record lookups",
...
var app = utils.NewApp(gitCommit, "Estchain Swarm")

// This init function creates the cli.App.
func init() {
	app.Action = bzzd
	app.HideVersion = true // we have a command to print the version
	app.Copyright = "Copyright 2013-2016 The go-estchain Authors"
...
Export a local chunk database as a tar archive (use - to send to stdout).
    ...
    swarm db export ~/.estchain/swarm/bzz-KEY/chunks chunks.tar

The export may be quite large, consider piping the output through the Unix
pv(1) tool to get a progress bar:

    swarm db export ~/.estchain/swarm/bzz-KEY/chunks - | pv > chunks.tar
`,
				},
				{
					Action:    dbImport,
...
Import chunks from a tar archive into a local chunk database (use - to read from stdin).
    ...
    swarm db import ~/.estchain/swarm/bzz-KEY/chunks chunks.tar

The import may be quite large, consider piping the input through the Unix
pv(1) tool to get a progress bar:

    pv chunks.tar | swarm db import ~/.estchain/swarm/bzz-KEY/chunks -
`,
				},
				{
					Action:    dbClean,
