...
type wizard struct {
	...
	services map[string][]string   // Estchain services known to be running on servers
...
// converts it to an Estchain address. If an empty line is entered, the default
// value is returned.
