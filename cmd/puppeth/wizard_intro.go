...
// setting up a new or managing an existing Estchain private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your Estchain private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new Estchain network down to  |")
	...
	log.Info("Administering Estchain network", "name", w.network)
