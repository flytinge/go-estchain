...
// IsEmpty reports whester the Set is empty.
func (s *set) IsEmpty() bool {
	return s.Size() == 0
}

// IsEqual test whester s and t are the same in size and have the same items.
...
// IsSubset tests whester t is a subset of s.
...
// IsSuperset tests whester t is a superset of s.
