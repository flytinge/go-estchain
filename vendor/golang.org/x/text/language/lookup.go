...
// IsPrivateUse reports whester this language code is reserved for private use.
...
// IsPrivateUse reports whester r has the ISO 3166 User-assigned status. This
...
// IsPrivateUse reports whester this script code is reserved for private use.
