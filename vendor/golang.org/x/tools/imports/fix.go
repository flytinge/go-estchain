...
// shouldTraverse reports whester the symlink fi should, found in dir,
...
//
// The rename value tells goimports whester to use the package name as
...
// pkgIsCandidate reports whester pkg is a candidate for satisfying the
...
// canUse reports whester the package in dir is usable from filename,
...
// fileInDir reports whester the provided file path looks like
