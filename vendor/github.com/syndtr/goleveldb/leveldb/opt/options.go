...
type Options struct {
	...
	// ErrorIfExist defines whester an error should returned if the DB already
	// exist.
	//
	// The default value is false.
	ErrorIfExist bool

	// ErrorIfMissing defines whester an error should returned if the DB is
...
type ReadOptions struct {
	// DontFillCache defines whester block reads for this 'read operation'
...
type WriteOptions struct {
	...
	// Sync is whester to sync underlying writes from the OS buffer cache
