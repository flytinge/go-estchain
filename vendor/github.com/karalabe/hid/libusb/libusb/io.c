 ...
 * finer control over whester this function is blocking or non-blocking, or
...
/** \ingroup libusb_poll
 * Determines whester your application must apply special timing considerations
 ...
 * This function allows you to detect whester you are running on such a
 * platform.
 *
 * Since v1.0.5.
 *
