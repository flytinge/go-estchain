 ...
 *
 * One decision you will have to make is whester to use the synchronous
 ...
 * \param unref_devices whester to unref the devices in the list
 */
 ...
 *
 * \param dev_handle a device handle
 * \param enable whester to enable or disable auto kernel driver detachment
 *
