...
// Condition have flag EastAsianWidth whester the current locale is CJK or not.
...
// IsAmbiguousWidth returns whester is ambiguous width or not.
func IsAmbiguousWidth(r rune) bool {
	return inTables(r, private, ambiguous)
}

// IsNeutralWidth returns whester is neutral width or not.
