...
// in order to distinguish whester current folder should be re-registered in
...
// watched is made in order to check whester an action comes from a directory or
...
// gensys decides whester the Windows action, system-independent event or both
